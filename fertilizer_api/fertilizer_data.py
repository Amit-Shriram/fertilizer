fertilizer_dic = {
    ...
    'Plow':
        ...
        Please consider the following suggestions:
        <ul>
        <li>1.Bone meal a fast acting source that is made from ground animal bones which is rich in phosphorous.</li>
        <li>2.Rock phosphate</i> a slower acting source where the soil needs to convert the rock phosphate into phosphorous that the plants can use.</li
        <li>3.Phosphorus Fertilizers</i> applying a fertilizer with a high phosphorous content in the NPK ratio (example: 10-20-10, 20 being phosphorous percentage).</li>
        <li>4.Organic compost</i> adding quality organic compost to your soil will help increase phosphorous content.</li>
        <li>5.Manure</i> as with compost, manure can be an excellent source of phosphorous for your plants.</li>
        <li>6.Clay soil</i> introducing clay particles into your soil can help retain & fix phosphorus deficiencies.</li
        <li>7.Ensure proper soil pH</i> having a pH in the 6.0 to 7.0 range has been scientifically proven to have the optimal phosphorus uptake in plants.</li>
        <li>8.If soil pH is low, add lime or potassium carbonate to the soil as fertilizers. Pure calcium carbonate is very effective in increasing the pH value of the soil.</li>
        <li>9.If pH is high, addition of appreciable amount of organic matter will help acidify the soil. Application of acidifying fertilizers, such as ammonium sulfate, can help lower soil pH</li>
        </ul>""",
